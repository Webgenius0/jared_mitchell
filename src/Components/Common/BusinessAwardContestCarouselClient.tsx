...
interface BusinessAwardContestCarouselClientProps {
...
export default function BusinessAwardContestCarouselClient({
  rounds,
  activeRoundId,
  title = "OSI Top Business Award Contest",
  autoPlay = true,
}: BusinessAwardContestCarouselClientProps) {
  ...
  const handleViewProfile = (businessName: string, businessId?: number) => {
    ...
    router.push(`/business-award-contest/profile/${roundSlug}/${slug}`);
  };
