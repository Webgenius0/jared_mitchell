  ...
  return (
    ...
    >
      <div className="h-full container flex flex-col items-center justify-center px-4 sm:px-6">
        <h2 className="text-[22px] sm:text-4xl capitalize md:text-5xl lg:text-6xl font-bold leading-[130%] text-white text-center max-w-[968px] mx-auto text-balance px-2">
