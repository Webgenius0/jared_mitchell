  ...
  return (
    <>
      ...
      <section className="section container">
        ...
        <p className="section_sub_title mt-4 md:mt-5 lg:mb-6 xl:mb-12 max-w-[1000px] mx-auto">
      ...
      {cmsData?.services_risk_free && (
        <section className="bg-[#4680FF] py-8 md:py-10 lg:py-10 xl:py-16 px-4 md:px-5 mt-8 md:mt-10 lg:mt-12">
          <div className="container mx-auto max-w-4xl text-center flex flex-col items-center">
            {/* Top Shield Badge */}
            <div className="mb-3 md:mb-4 lg:mb-5 flex h-8 w-8 md:h-10 md:w-10 lg:h-11 lg:w-11 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm text-white border border-white/30">
            ...
            {/* Main Title */}
            <h2 className="text-lg md:text-2xl lg:text-3xl xl:text-5xl font-bold mb-2.5 md:mb-3 lg:mb-4 text-white tracking-wide">
              {cmsData.services_risk_free.title}
            </h2>

            {/* Subtitle - constrained width forces clean wrapping */}
            <p className="text-xs md:text-sm lg:text-base text-white/90 mb-4 md:mb-5 lg:mb-6 max-w-2xl leading-relaxed">
