  ...
  return (
    <section className="py-10 xl:py-20">
      <div className="container grid md:grid-cols-2 gap-5 md:gap-10 xl:gap-20 items-center">
        {/* Left */}
        <div>
          <h2 className="text-primary-black text-4xl xl:text-5xl font-bold leading-[140%] max-w-[602px] mb-3 xl:mb-5">
            Who We Serve
          </h2>
          ...
          <p className="text-xl xl:text-2xl text-[#364153] leading-[150%] pt-4">
