  ...
  return (
    <section className="py-20 container">
      <div className="max-w-[1200px] mx-auto">
        <h2 className="text-primary-black text-5xl font-bold leading-[140%] text-center mb-3">
          Our Impact
        </h2>

        <p className="text-[#1D1D1F] text-center text-xl leading-[150%] max-w-[900px] mx-auto mb-12">
        ...
        <div className="flex justify-between items-center">
          <div className="space-y-5">
            {data?.slice(0, 3)?.map((item, idx) => (
              <div
                key={idx}
                className="flex items-center gap-2.5 text-[#364153] text-xl"
              >
                <VisibilitySvg />
                <span>{item}</span>
              </div>
