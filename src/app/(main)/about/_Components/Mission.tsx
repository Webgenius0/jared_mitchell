  ...
  return (
    <section className="container py-10 xl:py-20">
      ...
      <div className="flex flex-col md:flex-row gap-5">
        {/* Left */}
        <div className="flex-1 bg-[#DB0F190A]  py-8 xl:py-12 flex flex-col justify-center items-center rounded-xl space-y-5 text-center px-12 xl:px-20 shadow-[0_4px_20px_0_rgba(0,0,0,0.07)] border border-[#0000000e]">
          <AOneSvg />
          <h3 className="text-primary-black text-3xl xl:text-4xl font-bold">
            Mission
          </h3>
        ...
        {/* Right */}
        <div className="flex-1 bg-[#FFCE290A] py-8 xl:py-12 flex flex-col justify-center items-center rounded-xl space-y-5 text-center px-12 xl:px-20 shadow-[0_4px_20px_0_rgba(0,0,0,0.07)] border border-[#0000000e]">
          <ATwoSvg />
          <h3 className=" text-primary-black text-3xl xl:text-4xl font-bold">
            Purpose
          </h3>
