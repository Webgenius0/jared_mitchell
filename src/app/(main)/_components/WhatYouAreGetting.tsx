  ...
  return (
    <section className="section">
      <Container>
        ...
        <p className="text-2xl text-center text-secondary-black mt-4">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 self-stretch mt-11">
          {data?.map(data => (
            <div
              key={data.id}
              className="rounded-xl max-w-[369px] w-full py-20 px-7 flex items-center flex-col border space-y-4 border-[rgba(0,0,0,0.16)] shadow"
            >
              ...
              <h4 className="text-[22px] text-center self-stretch font-semibold text-primary-black">
                {data.title}
              </h4>
            </div>
          ))}
