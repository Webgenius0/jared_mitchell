...
const WhyChoose = ({ data }: { data?: CMSWhyChoose }) => {
  ...
  return (
    <div className="container py-4 md:py-5 lg:py-6 xl:py-12">
      <div className="text-center mb-3 md:mb-3.5 lg:mb-4 xl:mb-8">
      ...
      >
        {items.map((item, index) => (
          <SwiperSlide key={index}>
            <section className="w-full h-[220px] md:h-[240px] lg:h-[260px] xl:h-[460px] overflow-hidden flex items-center relative">
              <Image
                src={item?.image || osi}
                fill
              ...
              <div className="w-full h-full absolute top-0 bg-gradient-to-t from-black/85 via-black/50 to-black/35 ">
                <div className="flex flex-col w-full mx-auto h-full items-center justify-center">
                  ...
                  <h4 className="text-white text-sm md:text-base lg:text-lg xl:text-2xl text-center font-medium mb-1 md:mb-1.5 lg:mb-2">
                    {item?.sub_title ||
