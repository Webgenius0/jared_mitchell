...
const FeaturedEvent = () => {
  return (
    <section className="section bg-[#F5F5F7]">
      <div className="flex gap-14 max-lg:flex-col container">
        <figure className="lg:basis-1/2 relative w-[716px] h-[627px] rounded-[40px]">
          ...
          />
          <div className="absolute top-7 left-7 text-xl px-5 py-4 rounded-full text-primary-blue bg-[#eff6ff]">
            Featured Event
          </div>
        </figure>
        <div className="lg:basis-1/2">
          ...
          <p className="text-2xl text-primary-black mt-3">
          ...
          <div className="py-5 mt-3 mb-7 border-b border-gray-200 text-secondary-black flex items-center gap-12">
            <div className="flex items-center gap-6">
              <div className="flex items-center justify-center size-[48px] aspect-square rounded-full bg-white custom_shadow border border-gray-200">
