...
const EventBanner = ({ data }: { data?: CMSCTA }) => {
  return (
     <section className="w-full max-h-[580px] h-full overflow-hidden flex items-center relative">
        <Image src={data?.bg || "/home/home-banner-2.jpg"} width={1920} height={580} alt="home banner" className="object-cover w-full" />
        <div className="w-full h-full absolute top-0 bg-black/60">
          <div className="flex flex-col max-w-[1200px] w-full mx-auto h-full items-center justify-center text-center px-4">
            <h2 className="section_title !text-white 2xl:text-6xl">{data?.title || "Events"}</h2>
