    ...
    <section className="text-center bg-[#F5F5F7] py-8 md:py-10 lg:py-10 2xl:py-12">
      <div className="container">
        ...
        <div className="max-w-[1179px] w-full mx-auto my-3 md:w-[620px] md:mx-auto md:my-4 lg:w-[620px] lg:mx-auto lg:my-4 xl:max-w-[1179px] xl:w-full xl:my-6">
          ...
          <div className="relative w-full  lg:w-full h-[420px] overflow-hidden">
          ...
          {(headshotSrc || mediaItems.length > 1) && (
            <div className="flex items-center gap-3 mt-3 md:mt-4">
              {headshotSrc && (
                <div className="relative w-14 h-14 md:w-16 md:h-16 lg:w-16 lg:h-16 xl:w-20 xl:h-20 rounded-full overflow-hidden border-2 border-white shadow-md shrink-0">
                  <Image
                    src={headshotSrc}
                    fill
                    sizes="80px"
              ...
              <div className="flex gap-2 overflow-x-auto">
                {mediaItems.slice(1).map((src, idx) => (
                  <div
                    key={idx}
                    className="relative w-14 h-14 md:w-16 md:h-16 lg:w-16 lg:h-16 rounded-lg overflow-hidden border border-gray-200 shrink-0"
                  >
                    <Image
                      src={src}
                      fill
