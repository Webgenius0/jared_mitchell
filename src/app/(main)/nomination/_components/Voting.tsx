    ...
    <div>
      <section className="space-y-4 px-6 py-8 rounded-2xl custom_border custom_shadow">
        <div className="space-y-6">
          <div className="flex gap-4 justify-between">
            <div>
              <h4 className="text-[#101828] text-[32px] font-medium mb-2">
                {activeRound.title}
              </h4>
        ...
        <div className="space-y-6">
          ...
          {activeRound.challenge && (
            <div className="bg-[#EFF6FF] custom_border custom_shadow space-y-4 px-6 py-8 rounded-xl">
              <h3 className="font-medium text-2xl text-primary-black">
                {activeRound.challenge.title}
              </h3>
              <p className="text-tertiary-blue text-xl">
                {activeRound.challenge.question}
              </p>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-secondary-black text-2xl mb-1">
                  Participants
                </p>
      ...
      <div className="my-[48px] px-6 py-8 flex items-center gap-4 justify-between rounded-xl custom_border custom_shadow bg-white">
        <div className="flex items-center gap-3">
          <button className="cursor-pointer rounded-lg px-4 py-2 bg-[#EFF6FF] text-[#1977DD] border border-[#1977DD] text-lg">
            All
          </button>
          <button className="cursor-pointer rounded-lg px-4 py-2 bg-[#F1F5F9] text-[#314158] text-lg">
            Advancing
          </button>
          <button className="cursor-pointer rounded-lg px-4 py-2 bg-[#F1F5F9] text-[#314158] text-lg">
            At Risk
        ...
        <div className="flex items-center gap-3">
          <PanelSvg />
          <button className="cursor-pointer rounded-lg px-5 py-2 custom_border flex items-center gap-4 text-[#314158] text-lg">
            All Categories <DownArrow />
          </button>
          <DoubleArrowSvg />
          <button className="cursor-pointer rounded-lg px-5 py-2 custom_border flex items-center gap-4 text-[#314158] text-lg">
            Highest Score <DownArrow />
          </button>
          <button className="cursor-pointer rounded-lg px-4 py-2 bg-[#F1F5F9] text-[#314158] text-lg">
            100 businesses
          </button>
            ...
            {Array(30)
              ...
              .map((_, index) => (
                <tr key={index} className="border-b border-gray-200">
                  ...
                  <td className="p-7">
                    <h6 className="text-primary-black text-xl">
                      Urban Threads Boutique
                    </h6>
                    <p className="text-secondary-black">Michael Johnson</p>
                  </td>
                  <td className="text-xl text-center text-primary-black">
                    Professional Services
                  </td>
                  <td className="p-7">
                    <p className="text-primary-blue text-2xl font-medium text-center">
                      4,821
                    </p>
                  ...
                  <td className="text-center text-2xl text-secondary-black">
                    - +34
                  </td>
                  <td className="p-7">
                    <div className="flex justify-end items-center">
                      <button className="py-2 px-4 flex items-center gap-1 rounded-lg bg-primary-blue text-white text-lg">
