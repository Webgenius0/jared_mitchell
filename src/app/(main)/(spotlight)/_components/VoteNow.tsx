...
const VoteNow = () => {
  ...
  return (
    <section className="pb-24">
      <Container>
        <div className="py-[52px] px-[54px] space-y-[44px] bg-secondary-gray custom_border custom_shadow">
          <div>
          ...
          <div className="bg-white custom_border custom_shadow p-10 text-center">
