                ...
                <div className="space-y-14 bg-white custom_border rounded-2xl custom_shadow py-14 px-12">
                  <div className="flex gap-5">
                    <figure className="size-[60px] shrink-0 relative">
                      ...
                      />
                      <div className="absolute -top-[5px] -left-2.5 size-[32px] flex items-center justify-center rounded-full bg-primary-black text-white text-sm">
                        #{user.rank}
                      </div>
                    </figure>
                    <div className="space-y-3">
                      ...
                      <div className="py-2 px-4 bg-[#F1F5F9] text-lg rounded-lg inline-block text-secondary-black">
                        {user.tag}
                      </div>
                      {user.socials && (
                        <div className="flex items-center gap-5 text-xl text-primary-blue">
                          {user.socials.website && (
                            <Link href={user.socials.website}>
                              <FiExternalLink />
                            </Link>
                          )}
                      ...
                      <div className="flex items-center gap-9 text-xl text-secondary-black">
                        ...
                        <div>Weekly Score: {user.weeklyScore ?? "0"}</div>
                      </div>
                    </div>
                  </div>
                  <div className="flex gap-5">
