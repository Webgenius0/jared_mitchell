  ...
  return (
    <div className="flex flex-col items-center gap-1.5 sm:gap-2">
      <div className="relative">
        {/* Digit container */}
        <div className="relative w-12 h-14 sm:w-16 sm:h-20 md:w-20 md:h-24 lg:w-22 lg:h-26 xl:w-24 xl:h-28 rounded-2xl overflow-hidden">
          {/* Background */}
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span
              className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white tabular-nums transition-all duration-300 ${
                isFlipping
      ...
      {/* Label */}
      <span className="text-[9px] sm:text-[10px] md:text-xs text-white/60 uppercase tracking-[0.15em] sm:tracking-[0.2em] font-medium">
        {label}
      </span>
    </div>
  );
...
const CountdownSeparator = () => (
  <div className="flex flex-col items-center gap-1.5 sm:gap-2 pt-1 sm:pt-2">
    <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 rounded-full bg-white/50 animate-pulse" />
    <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 rounded-full bg-white/50 animate-pulse" />
  </div>
);
...
const SpotlightCountdown = () => {
  ...
  return (
    <section className="py-8 md:py-10 lg:py-14 xl:py-16 2xl:px-5 3xl:px-5">
      <Container>
        {/* Smaller centered countdown component */}
        <div className="w-full max-w-[900px] mx-auto relative overflow-hidden rounded-3xl md:rounded-[2rem]">
          ...
          {/* Content */}
          <div className="relative z-10 px-4 md:px-6 lg:px-8 py-6 md:py-8 lg:py-10 xl:py-12">
            {/* Top badge */}
            ...
            {/* Week name */}
            <div className="text-center mb-5 md:mb-6 lg:mb-7 xl:mb-8">
              <p className="text-white/50 text-xs sm:text-sm uppercase tracking-[0.25em] mb-2">
                Spotlight Contest
              </p>

              <h3 className="text-white text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-1.5 md:mb-2">
                {countdownData!.name}
              </h3>
            ...
            {/* Countdown digits */}
            <div className="flex items-start justify-center gap-1.5 sm:gap-3 md:gap-4 lg:gap-5 xl:gap-6 mb-5 md:mb-6 lg:mb-7 xl:mb-8">
              <CountdownDigit
                value={timeLeft!.days}
                label="Days"
              />
