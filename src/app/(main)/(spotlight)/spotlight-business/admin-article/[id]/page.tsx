...
interface SpotlightAdminArticleDetailPageProps {
  params: Promise<{ id: string }>;
}

const SpotlightAdminArticleDetailPage = async ({
  params,
}: SpotlightAdminArticleDetailPageProps) => {
  ...
  let article = null;
  try {
    const res = await getSpotlightOfTheWeek("business");
...
export default SpotlightAdminArticleDetailPage;
