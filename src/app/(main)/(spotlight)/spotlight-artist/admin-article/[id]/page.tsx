...
import { getSpotlightOfTheWeek } from "@/lib/Services/cms_service";

interface SpotlightArtistAdminArticleDetailPageProps {
  params: Promise<{ id: string }>;
}

const SpotlightArtistAdminArticleDetailPage = async ({
  params,
}: SpotlightArtistAdminArticleDetailPageProps) => {
  ...
  let article = null;
  try {
    const res = await getSpotlightOfTheWeek("artist");
    const articles = res?.data?.admin_articles ?? [];
...
export default SpotlightArtistAdminArticleDetailPage;
