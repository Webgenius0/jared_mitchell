...
import { CMSBusinessAwardSteps, RoundLeaderboardData } from "@/Types/cms";
import {
  apiClapBusiness,
  apiSaveBusiness,
  apiShareBusiness,
  ...
  return (
    <div className="rounded-2xl border border-slate-200 overflow-hidden bg-white">
      ...
      <div className="p-4">
        ...
        <Link
          href={`/business-award-contest/profile/round-${roundNumber}/${biz.id}`}
