...
const AdminArticlesSection = ({ articles }: AdminArticlesSectionProps) => {
  if (!articles || articles.length === 0) {
    return null;
  }

  return (
    <section className="container lg:mt-8 xl:lg:mt-10 mt-4 lg:mt-5 xl:mt-12">
      ...
      <p className="text-sm md:text-base lg:text-lg xl:text-3xl text-center text-primary-black leading-relaxed">
        Read about our winners and their inspiring journeys.
      </p>

      <div className="w-full md:w-[450px] mt-4 md:mt-5 lg:mt-6 mx-auto">
          ...
          return (
            ...
            >
              ...
              <div className="p-4 md:p-5 lg:p-6 flex flex-col flex-1">
                ...
                {/* View Details Button */}
                <Link
                  href={`/boss-beginnings/admin-article/${article.id}`}
