...
export const metadata = {
  title: "Round 5 - OSI Top Business Award | Business Dashboard",
  description:
    "View your Round 5 statistics for the OSI Top Business Award. Track points, submissions, and progress in the fifth round of the Open Spotlight Initiative contest.",
  robots: {
    index: false,
    follow: false,
  },
